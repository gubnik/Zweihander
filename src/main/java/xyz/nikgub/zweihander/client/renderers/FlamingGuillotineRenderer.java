package xyz.nikgub.zweihander.client.renderers;
...
public class FlamingGuillotineRenderer extends EntityRenderer<FlamingGuillotineEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Zweihander.MOD_ID, "textures/entity/flaming_guillotine.png");
