...
import xyz.nikgub.zweihander.common.items.AccursedContractItem;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> INCENSE = ITEMS.register("incense", () -> new AccursedContractItem(new Item.Properties()));
